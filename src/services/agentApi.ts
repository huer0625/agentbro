...
const baseAgentPrograms: AgentProgramInfo[] = [
  ...
  { id: 'cline', displayName: 'Cline', icon: 'cline', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/Documents/Cline', appPath: '/Applications/Visual Studio Code.app', downloadUrl: 'https://cline.bot', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: null, isCustom: false },
  ...
  { id: 'traecli', displayName: 'TraeCli', icon: 'trae', kind: 'cli', status: 'notInstalled', packageManager: 'vendor', packageName: 'traecli', installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.trae', appPath: null, downloadUrl: 'https://www.trae.ai', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.trae/skills', isCustom: false },
  { id: 'traecn', displayName: 'Trae CN', icon: 'trae', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.trae-cn', appPath: '/Applications/TRAE SOLO CN.app', downloadUrl: 'https://www.trae.cn/ide/download#solo-download', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.trae-cn/skills', isCustom: false },
  ...
  { id: 'deepseek', displayName: 'DeepSeek', icon: 'deepseek', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.deepseek', appPath: '/Applications/DeepSeek.app', downloadUrl: 'https://www.deepseek.com', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: null, isCustom: false },
  ...
  { id: 'codebuddycn', displayName: 'CodyBuddyCN', icon: 'codebuddy', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.codybuddycn', appPath: '/Applications/CodyBuddyCN.app', downloadUrl: 'https://www.codebuddy.ai', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.codybuddycn/skills', isCustom: false },
  ...
  { id: 'factory-droid', displayName: 'Factory Droid', icon: 'factory-droid', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.factory', appPath: '/Applications/Factory.app', downloadUrl: 'https://www.factory.ai', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.factory/skills', isCustom: false },
  ...
  { id: 'windsurf', displayName: 'Windsurf', icon: 'windsurf', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.codeium/windsurf', appPath: '/Applications/Windsurf.app', downloadUrl: 'https://windsurf.com', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.windsurf/skills', isCustom: false },
  { id: 'augment', displayName: 'Augment', icon: 'augment', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.augment', appPath: '/Applications/Augment.app', downloadUrl: 'https://www.augmentcode.com', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.augment/skills', isCustom: false },
  ...
  { id: 'amp', displayName: 'Amp', icon: 'amp', kind: 'cli', status: 'notInstalled', packageManager: 'npm', packageName: '@sourcegraph/amp', installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.amp', appPath: null, downloadUrl: 'https://ampcode.com', installCommand: 'npm install -g @sourcegraph/amp', updateCommand: 'npm update -g @sourcegraph/amp', uninstallCommand: 'npm uninstall -g @sourcegraph/amp', hooksInstalled: false, skillsDir: '~/.amp/skills', isCustom: false },
  ...
  { id: 'openclaw', displayName: 'OpenClaw', icon: 'openclaw', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.openclaw', appPath: '/Applications/OpenClaw.app', downloadUrl: 'https://github.com/openclaw-ai/openclaw', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.openclaw/skills', isCustom: false },
  { id: 'qclaw', displayName: 'QClaw', icon: 'qclaw', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.qclaw', appPath: '/Applications/QClaw.app', downloadUrl: 'https://github.com/openclaw-ai/qclaw', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.qclaw/skills', isCustom: false },
  { id: 'easyclaw', displayName: 'EasyClaw', icon: 'easyclaw', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.easyclaw', appPath: '/Applications/EasyClaw.app', downloadUrl: 'https://github.com/openclaw-ai/easyclaw', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.easyclaw/skills', isCustom: false },
  { id: 'easyclaw-v2', displayName: 'EasyClaw V2', icon: 'easyclaw', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.easyclaw-20260322-01', appPath: '/Applications/EasyClaw.app', downloadUrl: 'https://github.com/openclaw-ai/easyclaw', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.easyclaw-20260322-01/skills', isCustom: false },
  { id: 'autoclaw', displayName: 'AutoClaw', icon: 'autoclaw', kind: 'app', status: 'notInstalled', packageManager: 'app', packageName: null, installedVersion: null, latestVersion: null, binaryPath: null, configDir: '~/.openclaw-autoclaw', appPath: '/Applications/AutoClaw.app', downloadUrl: 'https://github.com/openclaw-ai/autoclaw', installCommand: null, updateCommand: null, uninstallCommand: null, hooksInstalled: false, skillsDir: '~/.openclaw-autoclaw/skills', isCustom: false },
]

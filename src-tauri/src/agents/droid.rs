// DroidAdapter — Agent adapter for Factory (Droid) IDE
...
impl DroidAdapter {
    pub fn new() -> Self {
        ...
        let config_root = home.join(".factory");
...
impl AgentAdapter for DroidAdapter {
    ...
    fn install_hooks(&self) -> Result<(), Box<dyn std::error::Error>> {
        profiles::install_at(&profiles::droid_profile(), &self.settings_path())?;
        log::info!("Factory/Droid hooks installed");
        Ok(())
    }

    fn remove_hooks(&self) -> Result<(), Box<dyn std::error::Error>> {
        profiles::uninstall_at(&profiles::droid_profile(), &self.settings_path())?;
        log::info!("Factory/Droid hooks removed");
        Ok(())
    }
